...
- Support array format search keys in su-dropdown item
...
- Add deter-parent-update option to su-checkbox
...
- Fix the problem what change event does not fire when input field value is changed
...
[1.5.0]: https://github.com/black-trooper/semantic-ui-riot/compare/v1.4.0...v1.5.0
