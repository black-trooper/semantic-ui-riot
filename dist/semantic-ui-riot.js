...
var isUpward = function isUpward() {
  ...
  var currentMenu = _this.root.querySelector('.menu');
  ...
  var menuHeight = parseInt(document.defaultView.getComputedStyle(currentMenu, null).getPropertyValue('max-height').replace('px', ''));
